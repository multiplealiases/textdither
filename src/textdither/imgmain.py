...
def main():
    ...
    parser.add_argument("-s", "--image-size", required=True)
    ...
    width, height = parse_res(args.image_size)
    ...
    tmp = make_tokens(args.file, height, width, token_height, token_width, args.bytes_per_pixel)
